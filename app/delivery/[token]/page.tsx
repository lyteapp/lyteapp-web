...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    desc: 'Tu pedido esta en cocina, lo estan preparando con mucho cuidado.',
    icon: (active) => (
      <svg viewBox="0 0 24 24" fill="none" stroke={active ? '#F59E0B' : '#94A3B8'} strokeWidth="2" width="32" height="32">
  ...
  {
    key: 'ready',
    label: 'Siendo empacado',
    desc: 'Tu pedido ya esta listo y lo estan empacando para que llegue perfecto.',
    icon: (active) => (
      <svg viewBox="0 0 24 24" fill="none" stroke={active ? '#7C3AED' : '#94A3B8'} strokeWidth="2" width="32" height="32">
  ...
  {
    key: 'picked_up',
    label: 'Tu pedido esta saliendo',
    desc: 'El despachador ya tiene tu pedido y va en camino hacia ti.',
    icon: (active) => (
      <svg viewBox="0 0 24 24" fill="none" stroke={active ? '#7C3AED' : '#94A3B8'} strokeWidth="2" width="32" height="32">
  ...
  },
  {
    ...
    desc: 'Tu pedido llego exitosamente. Que lo disfrutes.',
    icon: (active) => (
      <svg viewBox="0 0 24 24" fill="none" stroke={active ? '#10B981' : '#94A3B8'} strokeWidth="2" width="32" height="32">
