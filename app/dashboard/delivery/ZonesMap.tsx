...
export default function ZonesMap({ zones, placingZone, onMapClick, previewCenter, previewRadius, previewColor, onUserPos }: Props) {
  ...
  if (error) return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#E8EEF4', padding: 24, textAlign: 'center', gap: 12 }}>
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <MapContainer
        center={pos}
        zoom={13}
        style={{ width: '100%', height: '100%', cursor: placingZone ? 'crosshair' : undefined }}
        zoomControl={true}
      >
        <TileLayer
