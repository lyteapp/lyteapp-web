              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {locationState === 'idle' && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    {mapboxToken && (
                      <button type="button" onClick={() => setShowMapPicker(true)} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, background: coAccentTint, color: coAccent, border: `1px solid ${coAccentFaint}`, borderRadius: 10, padding: '10px 14px', cursor: 'pointer', fontSize: 13, fontWeight: 600, width: '100%' }}>
                        <svg viewBox="0 0 20 20" fill="currentColor" width="14" height="14">
